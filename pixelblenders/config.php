<?php
    ...
    */
	...
	define( 'K_DB_NAME', 'loyola' );
    // 5.
	// Database username
	define( 'K_DB_USER', 'loyola' );
    // 6.
	// Database password 
	define( 'K_DB_PASSWORD', 'omgmango9' );
    // 7.
    ...
    define( 'K_PAID_LICENSE', 1 );
        ...
        define( 'K_LOGO_LIGHT', 'px.png' );

        // 99b. Company Logo on dark background  (Max. 171 x 64 pixels. Needs to be placed within 'couch/theme/images/' folder)
        define( 'K_LOGO_DARK', 'px_dark.png' );

        // 99c. Footer content (Company name and link)
        define( 'K_ADMIN_FOOTER', 'Designed by Naveen Shaji - &copy;2015 <a href="http://pixelblenders.com">PixelBlenders</a>' );
